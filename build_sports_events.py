...
def write_status(channels: list[tuple[str, str]], events: list[dict[str, Any]], manual_count: int, scraped_count: int, fallback_used: bool, manual_errors: list[str], config_errors: list[str], provider_statuses: dict[str, Any]) -> None:
    ...
    status = {
        ...
        "channel_extension_version": "v12-dazn-discovery-epg",
        "new_channel_groups": ["dazn.ucl.01-20", "ufcfightpass.24x7", "ufcfightpass.event.01-05"],
        "dazn_mapping_version": "v8-distributed-events",
        "dazn_filter_version": "v12-dazn-discovery-live-upcoming",
        "dazn_mapping_note": "v12 nutzt DAZN Discovery EPG als Hauptquelle. Live/UpComing werden auf DAZN-Gruppen verteilt; epg.pw bleibt Fallback. Boxen -> dazn.event.02, Fußball -> dazn.event.03, Radsport -> dazn.event.04, Reiten -> dazn.event.06, Motorsport -> dazn.event.07, MMA/UFC/Kampfsport -> dazn.ufc.01-10.",
